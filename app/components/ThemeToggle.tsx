...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="relative flex h-6 w-[52px] shrink-0 items-center rounded-full bg-[rgba(17,17,17,0.06)] p-0.5 transition-colors dark:bg-[rgba(255,255,255,0.08)]"
    >
      <span
...
function SunIcon({ active }: { active: boolean }) {
  return (
    <svg
      ...
      fill="currentColor"
      viewBox="0 0 16 16"
      className={active ? "text-[#111]" : "text-[rgba(17,17,17,0.35)] dark:text-[rgba(255,255,255,0.35)]"}
    >
...
function MoonIcon({ active }: { active: boolean }) {
  return (
    <svg
      ...
      fill="currentColor"
      viewBox="0 0 16 16"
      className={active ? "text-white" : "text-[rgba(17,17,17,0.35)] dark:text-[rgba(255,255,255,0.35)]"}
    >
